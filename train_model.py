...
class Ontology(object):
    def __init__(self, filename='/public/home/zhengly/CNNRNN/data/go.obo', with_rels=False):
...
def evaluate(model_file, data_path, data_size=8000, batch_size=16, term_path='data/terms.pkl'):
    ...
    # print(preds)
    # print(preds.shape)
    # pkl.dump(preds, open('preds_crnn.pkl', 'wb'))
...
def train_model(model_path, data_path, valid_path='none', epochs=60, batch_size=32, data_size=100000,
                terms_file='data/terms.pkl', early=True):
